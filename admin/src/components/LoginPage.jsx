                ...
                <form onSubmit={onSubmit} className='lg:w-[25vw] md:w-[50vw] w-[90vw] border border-gray-200/30 rounded-2xl flex items-start justify-center flex-col p-10 shadow-2xl'>
                    ...
                    <div className='w-full flex items-center justify-center flex-col gap-5'>
                        ...
                        <div className='w-full'>
                            ...
                            <input onChange={onChangeHandler} name='email' value={adminData.email} className='border border-gray-400/30 w-full pl-3 mt-2 rounded-sm px-2 py-2 cursor-pointer' type="text" placeholder='Type here ...' />
                        </div>
                        <div className='w-full'>
                            <p className='text-sm text-gray-500 tracking-wider'>Password</p>
                            <input onChange={onChangeHandler} name='password' value={adminData.password} className='border border-gray-400/30 w-full pl-3 mt-2 rounded-sm px-2 py-2 cursor-pointer' type="text" placeholder='Type here ...' />
                        </div>
                    </div>
